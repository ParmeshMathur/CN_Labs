...
void* decryptor (void* param)
{
	...
	// char* priv_key_file_name = (char*)param;
    printf("priv_key_file_name %s\n", priv_key_file_name);
...
void* encryptor (void* param)
{
	...
	// char* pub_key_file_name = (char*)param;
    printf("pub_key_file_name %s\n", pub_key_file_name);
	int exit_flag=0;

	// pub_key_fp=fopen(pub_key_file_name,"r");
 //    if(pub_key_fp==NULL)
 //    {
...
int main(int argc, char const *argv[])
{
    ...
    free(priv_key_file_name);
    free(pub_key_file_name);
